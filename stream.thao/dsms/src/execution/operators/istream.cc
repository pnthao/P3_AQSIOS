 ...
 */ 
bool Istream::calculateLocalStats() 
{
  ...
  if (!firstRefresh) { 
    ...
    //printf ( "ISTREAM OPERATOR %d costs %llu  n_tuples %d smoothed %f selectivity %f\n",
