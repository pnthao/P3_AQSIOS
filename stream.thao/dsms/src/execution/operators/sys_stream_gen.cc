	...
	: LOG (_LOG)
{
	...
	this -> operator_type = SYS_STREAM_GEN;
	this -> mean_cost = 1;
 ...
 * @return  void
 */ 
bool SysStreamGen::calculateLocalStats(){ return true; }
...
void SysStreamGen::refreshPriority(){}
// end of part 1 of HR implementation by LAM
 ...
 */
int SysStreamGen::readyToExecute() {
  return 1;
}

// end of part 1 of HR with ready by LAM
int SysStreamGen::run_with_shedder (TimeSlice timeSlice)
{
	return 0;
}
