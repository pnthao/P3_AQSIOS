...
query
   ...
   ;
*/
/*new, modified by Thao Pham */
query
   : RW_ACTIVE sfw_block
     {$$ = sfw_cont_query_node (true,$2, 0);}
     
   | sfw_block
     {$$ = sfw_cont_query_node (false,$1, 0);}
     
   | RW_ACTIVE xstream_clause '(' sfw_block ')'
     {$$ = sfw_cont_query_node (true, $4, $2);}
	
   | xstream_clause '(' sfw_block ')'
     {$$ = sfw_cont_query_node (false, $3, $1);}
     
   | RW_ACTIVE binary_op
     {$$ = bin_cont_query_node (true, $2, 0);}
    
   | binary_op
     {$$ = bin_cont_query_node (false, $1, 0);}
   
   | RW_ACTIVE xstream_clause '(' binary_op ')'
     {$$ = bin_cont_query_node (true, $4, $2);}
   
   | xstream_clause '(' binary_op ')'
     {$$ = bin_cont_query_node (false, $3, $1);}
   ;
