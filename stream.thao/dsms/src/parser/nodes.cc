...
// CONT_QUERY, modified by Thao Pham to add active/inactive specification
NODE *sfw_cont_query_node(bool b_active,NODE *sfw_block, NODE *reltostr_op) {
	...
	n -> u.CONT_QUERY.b_active = b_active;
	
	return n;
}

//BIN_CONT_QUERY, modified by Thao Pham to add active/inactive specification

NODE *bin_cont_query_node (bool b_active, NODE *bin_op, NODE *reltostr_op)
{
	NODE *n = newnode (N_CONT_QUERY);
