...
namespace Execution {
	...
	class SysStreamGen : public Operator {
		...
		static const int MAX_OPS    = 5000;//1000;
		static const int MAX_QUEUES = 5000;//1000;
		static const int MAX_SYNS   = 5000;//1000;
		static const int MAX_STORES = 5000;//1000;
		...
		static const int MAX_OUTPUT = 1000;//50;
		...
		static const int MAX_MEASURE = 7000;//2000;
