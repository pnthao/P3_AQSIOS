...
namespace Metadata {
	...
	private:
		...
		static const unsigned int MAX_QUEUES = 5000;//3000;
		
		/// Maximum number of synopses permitted in the system
		static const unsigned int MAX_SYNS = 5000;//2000;
		
		/// Maximum number of stores in the system
		static const unsigned int MAX_STORES = 5000;//1000;
		
		/// Maximum number of indexes in the system
		static const unsigned int MAX_INDEXES = 5000;//1000;
	...
	public:
		...
		//drop operators, by Thao Pham
		/*
		 * this method traverses the physical plan (after optimization and shared ops finding)
		 * looking for "safe" and "good" places to place inactive drop operators
		 * return 0 if success
		 */
		int insertDropOps();
	...
	private:
		...
		//note, by Thao Pham: drop operator doesn't need synopsis
		...
		/*//add "store" for drop operator, by Thao Pham
		int add_store_drop(Operator *op);
		//end of adding store for drop operator, by Thao Pham
		*/
		...
		//instantiate drop operator, by Thao Pham
		int inst_drop (Physical::Operator *op);
		//end of instantiating drop operator, by Thao Pham 
