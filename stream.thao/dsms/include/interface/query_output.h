 ...
 */
	...
	public:
		 ...
		 * @param  tuple            encoding of the tuple
		 * @param  len              Length of the encoding
		 * @param  responseTime     the response time of the tuple
		 * @param  time_unit        the length of the time_unit the 
		 *                          timestamp is in 
		 * @return                  0 (success), !0 (otherwise)
		 */	
		virtual int putNext(const char *tuple, unsigned int len,
				    unsigned long long int responseTime, int time_unit) = 0;
